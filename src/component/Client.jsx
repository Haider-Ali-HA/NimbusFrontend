  ...
  return (
    <>
      <div className="flex flex-col gap-10 font-inter">
        ...
        <div className="relative px-2 sm:w-5/6 mx-auto rounded-lg overflow-hidden shadow-lg">
          <img
            src={videoThumbnail}
          ...
          <Link to="https://www.youtube.com/watch?v=FE8NvDXbStk">
            ...
            >
              <IoPlayCircleOutline className="text-white text-xl sm:text-4xl " />
            </button>
          </Link>
          <div className="absolute -bottom-2 md:bottom-3 text-sm sm:text-lg left-0 right-0 bg-opacity-60 text-white py-3 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="mt-4 text-black text-sm md:text-base font-semibold">
                  {testimonial.quote}
                </p>
              </div>
            ))}
